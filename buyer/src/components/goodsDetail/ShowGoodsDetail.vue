...
export default {
  ...
  methods: {
    ...
    tabClick (name) { // Goods Detail和Evaluate之间的tab切换
      if (name === 0) {
        this.$nextTick(() => {
